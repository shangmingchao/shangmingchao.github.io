...
![linear regression](https://user-gold-cdn.xitu.io/2019/6/17/16b64f013e3d2f4f?w=1434&h=580&f=png&s=166700)
...
![loss](https://user-gold-cdn.xitu.io/2019/6/17/16b64f013e759136?w=688&h=276&f=png&s=44845)
...
![iterative approach](https://user-gold-cdn.xitu.io/2019/6/17/16b64f014023b69c?w=960&h=448&f=png&s=68682)
...
![convex](https://user-gold-cdn.xitu.io/2019/6/17/16b64f013e89b395?w=918&h=646&f=png&s=51336)
我们的目标就是不断改变 $w_1$ 的值直到找到唯一的损失最小的那个最低点（斜率为 0），即损失函数收敛的位置，迭代的策略有很多种，最常见的就是梯度下降法（gradient descent）  
![gradient descent](https://user-gold-cdn.xitu.io/2019/6/17/16b64f014036f495?w=936&h=620&f=png&s=107281)
...
![linear problem](https://user-gold-cdn.xitu.io/2019/6/17/16b64f02df914eb5?w=292&h=290&f=png&s=108368)
...
![regularization](https://user-gold-cdn.xitu.io/2019/6/17/16b64f03e25bfa37?w=670&h=308&f=png&s=45765)  
...
$$y = \frac{1}{1 + e^{-z}}$$  
![sigmoid function](https://user-gold-cdn.xitu.io/2019/6/17/16b64f0461bcdd6c?w=512&h=350&f=png&s=30178)
逻辑回归模型也类似：  
$$y' = \frac{1}{1 + e^{-(z)}}
$$  
![l](https://user-gold-cdn.xitu.io/2019/6/17/16b64f05cc21be3d?w=512&h=336&f=png&s=39818)
